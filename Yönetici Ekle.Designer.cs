namespace Emin_Dal
{
    partial class Yönetici_Ekle
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Yönetici_Ekle";
            this.Text = "Yönetici_Ekle";
