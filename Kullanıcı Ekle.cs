...
namespace Emin_Dal
{
    public partial class Kullanıcı_Ekle : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand command = new SqlCommand("INSERT INTO Kullanici (TC,Ad,Soyad,Dogum_Tarihi,Sifre,Statu) VALUES(@TC,@Ad,@Soyad,@Dogum_Tarihi,@Sifre,@Statu)", con);
                ...
                command.Parameters.Add(new SqlParameter("@Statu", cbxStatu.SelectedItem.ToString()));
